...
bool StateTransition::judge(int idx){
    ...
    switch(idx){
    //#<func_list>
        case 0: func = [](Judge& j) {return j.time.j(3000 * 1000);}; break;
        case 1: func = [](Judge& j) {return j.angle.j(360);}; break;
        case 2: func = [](Judge& j) {return j.time.j(3000 * 1000);}; break;
        case 3: func = [](Judge& j) {return j.angle.j(-460);}; break;
        case 4: func = [](Judge& j) {return j.time.j(1000 * 1000);}; break;
        case 5: func = [](Judge& j) {return j.ret.j(true) and j.time.j(5000 * 1000);}; break;
        case 6: func = [](Judge& j) {return j.time.j(1000 * 1000);}; break;
        ...
        case 14: func = [](Judge& j) {return j.time.j(20000 * 1000);}; break;
        case 15: func = [](Judge& j) {return j.time.j(30000 * 1000);}; break;
    //#</func_list>
        default: return true;
    }
