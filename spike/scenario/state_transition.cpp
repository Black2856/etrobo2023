...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 51: func = [](Judge& j) {return j.mileage.j(40) and j.brightness.j(50);}; break;
        ...
        case 67: func = [](Judge& j) {return j.mileage.j(500);}; break;
        case 68: func = [](Judge& j) {return j.mileage.j(1450);}; break;
