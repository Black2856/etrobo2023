...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 26: func = [](Judge& j) {return j.mileage.j(50);}; break;
        case 27: func = [](Judge& j) {return j.mileage.j(1000);}; break;
        case 28: func = [](Judge& j) {return j.mileage.j(850);}; break;
        case 29: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 30: func = [](Judge& j) {return j.mileage.j(100);}; break;
        ...
        case 34: func = [](Judge& j) {return j.mileage.j(50);}; break;
        case 35: func = [](Judge& j) {return j.mileage.j(1500);}; break;
        ...
        case 39: func = [](Judge& j) {return j.time.j(100 * 1000);}; break;
    //#</func_list>
        default: return true;
    }
