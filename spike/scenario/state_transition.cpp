...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 18: func = [](Judge& j) {return j.mileage.j(1500);}; break;
        case 19: func = [](Judge& j) {return j.time.j(50000*1000);}; break;
        ...
        case 25: func = [](Judge& j) {return j.mileage.j(50);}; break;
        case 26: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 27: func = [](Judge& j) {return j.mileage.j(350);}; break;
        case 28: func = [](Judge& j) {return j.mileage.j(2000);}; break;
        ...
        case 32: func = [](Judge& j) {return j.mileage.j(550);}; break;
        case 33: func = [](Judge& j) {return j.mileage.j(1600);}; break;
