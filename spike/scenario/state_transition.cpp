...
bool StateTransition::judge(int idx){
    ...
    switch(idx){
    //#<func_list>
        case 0: func = [](Judge& j) {return j.angle.j(360);}; break;
        case 1: func = [](Judge& j) {return j.angle.j(-460);}; break;
        case 2: func = [](Judge& j) {return j.time.j(1000 * 1000);}; break;
        case 3: func = [](Judge& j) {return j.ret.j(true) and j.time.j(5000 * 1000);}; break;
        ...
        case 12: func = [](Judge& j) {return j.time.j(20000 * 1000);}; break;
        case 13: func = [](Judge& j) {return j.time.j(30000 * 1000);}; break;
    //#</func_list>
        default: return true;
    }
