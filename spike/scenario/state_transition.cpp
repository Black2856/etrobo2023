...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 25: func = [](Judge& j) {return j.time.j(3000*1000);}; break;
        case 26: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 27: func = [](Judge& j) {return j.angleMinifig.j(2);}; break;
        case 28: func = [](Judge& j) {return j.mileage.j(400);}; break;
        ...
        case 32: func = [](Judge& j) {return j.time.j(100*1000);}; break;
        ...
        case 38: func = [](Judge& j) {return j.time.j(100*1000);}; break;
        case 39: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 40: func = [](Judge& j) {return j.time.j(3000*1000);}; break;
        ...
        case 44: func = [](Judge& j) {return j.time.j(100*1000);}; break;
        ...
        case 49: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
