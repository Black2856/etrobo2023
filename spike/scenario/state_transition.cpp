...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 13: func = [](Judge& j) {return j.mileage.j(2000);}; break;
        case 14: func = [](Judge& j) {return j.mileage.j(2500);}; break;
        case 15: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 16: func = [](Judge& j) {return j.mileage.j(50);}; break;
        case 17: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 18: func = [](Judge& j) {return j.mileage.j(2350);}; break;
        case 19: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 20: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 21: func = [](Judge& j) {return j.mileage.j(2000);}; break;
        case 22: func = [](Judge& j) {return j.mileage.j(550);}; break;
        case 23: func = [](Judge& j) {return j.mileage.j(1600);}; break;
