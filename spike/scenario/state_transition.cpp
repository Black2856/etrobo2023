...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 15: func = [](Judge& j) {return j.time.j(1000*1000);}; break;
        ...
        case 19: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
        ...
        case 26: func = [](Judge& j) {return j.angleMinifig.j(2);}; break;
        case 27: func = [](Judge& j) {return j.mileage.j(600);}; break;
        case 28: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 29: func = [](Judge& j) {return j.mileage.j(300);}; break;
        ...
        case 33: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
        case 34: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 35: func = [](Judge& j) {return j.ret.j(true) and (1500*1000);}; break;
        ...
        case 39: func = [](Judge& j) {return j.time.j(1000*1000);}; break;
        case 40: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 41: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
        case 42: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 43: func = [](Judge& j) {return j.ret.j(true) and (1500*1000);}; break;
        case 44: func = [](Judge& j) {return j.angleMinifig.j(2);}; break;
        case 45: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
