...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 24: func = [](Judge& j) {return j.time.j(100*1000);}; break;
        case 25: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 26: func = [](Judge& j) {return j.time.j(3000*1000);}; break;
        ...
        case 30: func = [](Judge& j) {return j.mileage.j(400);}; break;
        ...
        case 36: func = [](Judge& j) {return j.time.j(3000*1000);}; break;
        ...
        case 41: func = [](Judge& j) {return j.time.j(100*1000);}; break;
        case 42: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 43: func = [](Judge& j) {return j.time.j(3000*1000);}; break;
        ...
        case 48: func = [](Judge& j) {return j.time.j(1000*1000);}; break;
