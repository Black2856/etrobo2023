...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 5: func = [](Judge& j) {return j.time.j(200 * 1000);}; break;
        case 6: func = [](Judge& j) {return j.ret.j(true) and j.time.j(1500 * 1000);}; break;
        case 7: func = [](Judge& j) {return j.time.j(100 * 1000);}; break;
        case 8: func = [](Judge& j) {return j.button.j(4, true) or j.touch.j(true);}; break;
        case 9: func = [](Judge& j) {return j.mileage.j(2700);}; break;
        case 10: func = [](Judge& j) {return j.mileage.j(600);}; break;
        case 11: func = [](Judge& j) {return j.mileage.j(1600);}; break;
        ...
        case 15: func = [](Judge& j) {return j.mileage.j(2000);}; break;
        case 16: func = [](Judge& j) {return j.mileage.j(2500);}; break;
        ...
        case 22: func = [](Judge& j) {return j.mileage.j(500);}; break;
        case 23: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 24: func = [](Judge& j) {return j.mileage.j(2000);}; break;
        case 25: func = [](Judge& j) {return j.mileage.j(500);}; break;
        case 26: func = [](Judge& j) {return j.mileage.j(1600);}; break;
        case 27: func = [](Judge& j) {return j.time.j(100 * 1000);}; break;
        case 28: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 29: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 30: func = [](Judge& j) {return j.time.j(100 * 1000);}; break;
    //#</func_list>
        default: return true;
    }
