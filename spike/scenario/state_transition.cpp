...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 35: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
        case 36: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 37: func = [](Judge& j) {return j.ret.j(true) and (1500*1000);}; break;
        ...
        case 43: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
        case 44: func = [](Judge& j) {return j.ret.j(true);}; break;
        case 45: func = [](Judge& j) {return j.ret.j(true) and (1500*1000);}; break;
