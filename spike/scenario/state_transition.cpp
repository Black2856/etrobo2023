...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 12: func = [](Judge& j) {return j.mileage.j(200);}; break;
        case 13: func = [](Judge& j) {return j.mileage.j(200);}; break;
        case 14: func = [](Judge& j) {return j.time.j(500*1000);}; break;
        ...
        case 18: func = [](Judge& j) {return j.time.j(4000*1000);}; break;
