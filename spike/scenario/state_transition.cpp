...
bool StateTransition::judge(int idx){
    ...
    //#<func_list>
        ...
        case 15: func = [](Judge& j) {return j.mileage.j(500);}; break;
        ...
        case 27: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
        ...
        case 37: func = [](Judge& j) {return j.time.j(5000*1000);}; break;
