...
run.makeTRACE(6, 85.0, -0.08, 0.0, -0.07, 0.5);
run.makeTRACE(7, 60.0, -0.85, 0.0, -0.42, 0.4);
run.makeTRACE(8, 80.0, -0.08, 0.0, -0.07, 0.5);
run.makeTRACE(9, 60.0, -0.85, 0.0, -0.42, 0.4);
run.makeSTOP(10, 0.0);
...
doubleloop.makeTRACE(21, 70.0, 0.6, 0.0, 0.5, 1.0);
...
doubleloop.makeMANUAL_PID(27, 5.0, 60.0, 1.0);
doubleloop.makeTRACE(28, 70.0, 0.6, 0.0, 0.5, 1.0);
doubleloop.makeTRACE(29, 70.0, 0.6, 0.0, 0.5, 0.5);
...
doubleloop.makeMANUAL_PID(44, 5.0, -60.0, 1.0);
