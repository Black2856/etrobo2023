...
doubleloop.makeMANUAL_PID(47, 2, 80.0, -55.0);
doubleloop.makeTRACE(48, 55, -0.47, 0.0, -0.55, 0.5);
...
straight.makeTRACE(52, 50.0, 0.4, 0.0, 0.6, 0.5);
straight.makeSTOP(53, 0.0);
manage_scenario.add(straight);

Manage_scene right("right");
right.makeMANUAL_PID(54, 2.0, 80.0, -80.0);
right.makeMANUAL_PID(55, 5.0, 80.0, 1.0);
right.makeSTOP(56, 0.0);
manage_scenario.add(right);

Manage_scene left("left");
left.makeMANUAL_PID(57, 2.0, 80.0, 80.0);
left.makeMANUAL_PID(58, 5.0, -80.0, 1.0);
...
whileRun.makeMANUAL_PID(64, 1, 65.0, 35.0);
whileRun.makeSTOP(65, 0);
whileRun.makeMANUAL_PID(66, 2, 80.0, -90.0);
whileRun.makeSTOP(67, 0);
whileRun.makeMANUAL_PID(68, 1, 65.0, 565.0);
whileRun.makeSTOP(69, 0);
manage_scenario.add(whileRun);

Manage_scene LtoR("LtoR");
LtoR.makeSTOP(70, 0.0);
LtoR.makeMANUAL_PID(71, 4.0, 80.0, -45.0);
LtoR.makeSTOP(72, 0.0);
LtoR.makeMANUAL_PID(73, 3.0, 80.0, 40.0);
LtoR.makeSTOP(74, 0.0);
LtoR.makeMANUAL_PID(75, 5.0, -65.0, 1.0);
LtoR.makeSTOP(76, 0.0);
manage_scenario.add(LtoR);

Manage_scene RtoL("RtoL");
RtoL.makeSTOP(77, 0.0);
RtoL.makeMANUAL_PID(78, 3.0, 80.0, 45.0);
RtoL.makeSTOP(79, 0.0);
RtoL.makeMANUAL_PID(80, 4.0, 80.0, -40.0);
RtoL.makeSTOP(81, 0.0);
RtoL.makeMANUAL_PID(82, 5.0, 65.0, 1.0);
RtoL.makeSTOP(83, 0.0);
manage_scenario.add(RtoL);

Manage_scene goal("goal");
goal.makeMANUAL(84, 1.0, 70.0, 0.5);
goal.makeMANUAL_PID(85, 1.0, 70.0, 20.0);
goal.makeSTOP(86, 0.0);
goal.makeMANUAL_PID(87, 2.0, 80.0, 80.0);
goal.makeMANUAL_PID(88, 5.0, -80.0, 1.0);
goal.makeSTOP(89, 0.0);
goal.makeTRACE(90, 55.0, 0.15, 0.0, 0.2, 0.3);
