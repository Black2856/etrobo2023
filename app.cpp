...
doubleloop.makeTRACE(13, 75.0, 0.5, 0.0, 0.3, 0.5);
doubleloop.makeMANUAL_PID(14, 2.0, 60.0, 15.0);
doubleloop.makeTRACE(15, 50.0, -0.7, 0.0, -0.4, 0.5);
doubleloop.makeMANUAL_PID(16, 2.0, 60.0, 20.0);
doubleloop.makeTRACE(17, 60.0, -0.7, 0.0, -0.4, 0.5);
doubleloop.makeMANUAL_PID(18, 1.0, 60.0, 150.0);
doubleloop.makeMANUAL_PID(19, 2.0, 55.0, -5.0);
doubleloop.makeTRACE(20, 55.0, -1.0, 0.0, -1.0, 0.5);
