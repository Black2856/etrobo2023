...
RtoL.makeMANUAL_PID(70, 3.0, 80.0, -35.0);
RtoL.makeMANUAL_PID(71, 4.0, 80.0, 35.0);
RtoL.makeMANUAL_PID(72, 5.0, 65.0, 1.0);
RtoL.makeSTOP(73, 0.0);
manage_scenario.add(RtoL);

Manage_scene RtoL("RtoL");
RtoL.makeMANUAL_PID(74, 4.0, 80.0, 35.0);
RtoL.makeMANUAL_PID(75, 3.0, 80.0, -35.0);
