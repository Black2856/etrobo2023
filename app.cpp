...
doubleloop.makeMANUAL_PID(11, 2.0, 65.0, -45.0);
doubleloop.makeMANUAL_PID(12, 5.0, -65.0, 1.0);
doubleloop.makeTRACE(13, 75.0, 0.6, 0.0, 0.4, 0.5);
doubleloop.makeMANUAL_PID(14, 2.0, 65.0, 45.0);
doubleloop.makeMANUAL_PID(15, 5.0, 65.0, 1.0);
doubleloop.makeTRACE(16, 75.0, -0.6, 0.0, -0.4, 0.5);
doubleloop.makeSTOP(17, 0.0);
doubleloop.makeMANUAL_PID(18, 2.0, 80.0, 100.0);
doubleloop.makeSTOP(19, 0.0);
doubleloop.makeTAKE_PHOTO(20, 1.0);
doubleloop.makeSTOP(21, 0.0);
doubleloop.makeMANUAL_PID(22, 2.0, 80.0, -120.0);
doubleloop.makeMANUAL_PID(23, 5.0, -80.0, 1.0);
doubleloop.makeTRACE(24, 75.0, 0.9, 0.0, 0.7, 1.0);
doubleloop.makeSTOP(25, 0.0);
doubleloop.makeMANUAL_PID(26, 2.0, 80.0, 130.0);
doubleloop.makeSTOP(27, 0.0);
doubleloop.makeTAKE_PHOTO(28, 1.0);
doubleloop.makeSTOP(29, 0.0);
doubleloop.makeMANUAL_PID(30, 2.0, 80.0, -130.0);
doubleloop.makeMANUAL_PID(31, 5.0, -80.0, 1.0);
doubleloop.makeTRACE(32, 75.0, 0.8, 0.0, 0.7, 1.0);
doubleloop.makeTRACE(33, 75.0, 0.8, 0.0, 0.7, 0.5);
doubleloop.makeMANUAL_PID(34, 2.0, 60.0, 15.0);
doubleloop.makeTRACE(35, 60.0, -0.85, 0.0, -0.8, 0.5);
doubleloop.makeSTOP(36, 0.0);
doubleloop.makeMANUAL_PID(37, 2.0, 80.0, -100.0);
doubleloop.makeSTOP(38, 0.0);
doubleloop.makeTAKE_PHOTO(39, 1.0);
doubleloop.makeSTOP(40, 0.0);
doubleloop.makeMANUAL_PID(41, 2.0, 80.0, 130.0);
doubleloop.makeMANUAL_PID(42, 5.0, 80.0, 1.0);
doubleloop.makeTRACE(43, 70.0, -0.85, 0.0, -0.8, 1.0);
doubleloop.makeSTOP(44, 0.0);
doubleloop.makeMANUAL_PID(45, 2.0, 60.0, -100.0);
doubleloop.makeSTOP(46, 0.0);
doubleloop.makeTAKE_PHOTO(47, 1.0);
doubleloop.makeSTOP(48, 0.0);
doubleloop.makeMANUAL_PID(49, 2.0, 80.0, 130.0);
doubleloop.makeMANUAL_PID(50, 5.0, 80.0, 1.0);
doubleloop.makeTRACE(51, 70.0, -0.85, 0.0, -0.8, 1.0);
doubleloop.makeMANUAL_PID(52, 2.0, 65.0, -30.0);
doubleloop.makeTRACE(53, 55.0, -0.12, 0.0, -0.1, 0.5);
