...
doubleloop.makeTRACE(33, 75, 0.8, 0.0, 0.7, 1.0);
...
doubleloop.makeTAKE_PHOTO(47, 1);
...
doubleloop.makeTRACE(53, 55, -0.37, 0.0, -0.55, 0.5);
...
straight.makeMANUAL_PID(57, 1.0, 75.0, 360.0);
...
goal.makeMANUAL_PID(92, 5.0, -80.0, 1.0);
goal.makeSTOP(93, 0.0);
goal.makeTRACE(94, 85.0, -0.09, 0.0, -0.12, 0.3);
