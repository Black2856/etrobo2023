...
calibration.makeMANUAL(1, 2, 50.0, 0.3);
calibration.makeSTOP(2, 0);
calibration.makeCALIBRATION("record");
calibration.makeMANUAL(3, 2, -50.0, 0.15);
calibration.makeSTOP(4, 0);
calibration.makeCALIBRATION("stop");
calibration.makeON_LINE_MOVE(5, 50, -0.4, 0.0, 0.3);
...
run.makeTRACE(8, 80.0, 0.7, 0.0, 0.4, 1.0);
...
test.makeMANUAL(14, 1.0, 100.0, 0.1);
