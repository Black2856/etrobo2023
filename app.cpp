...
right.makeMANUAL_PID(52, 2.0, 80.0, -90.0);
right.makeSTOP(53, 0.0);
manage_scenario.add(right);

Manage_scene left("left");
left.makeMANUAL_PID(54, 2.0, 80.0, 90.0);
left.makeSTOP(55, 0.0);
manage_scenario.add(left);

Manage_scene whileRun("whileRun");
whileRun.makeCALL_SCENARIO("LtoR");
whileRun.makeTRACE(56, 60, 0.6, 0.0, 0.7, 0.5);
whileRun.makeCALL_SCENARIO("RtoL");
whileRun.makeTRACE(57, 65, -1.0, 0.0, -1.0, 0.4);
whileRun.makeTRACE(58, 80, -0.12, 0.0, -0.1, 0.5);
whileRun.makeTRACE(59, 60, -0.12, 0.0, -0.1, 0.5);
whileRun.makeMANUAL_PID(60, 1, 65.0, 35.0);
whileRun.makeSTOP(61, 0);
whileRun.makeMANUAL_PID(62, 2, 80.0, -90.0);
whileRun.makeSTOP(63, 0);
whileRun.makeMANUAL_PID(64, 1, 65.0, 565.0);
whileRun.makeSTOP(65, 0);
manage_scenario.add(whileRun);

Manage_scene LtoR("LtoR");
LtoR.makeSTOP(66, 0.0);
LtoR.makeMANUAL_PID(67, 4.0, 80.0, -45.0);
LtoR.makeSTOP(68, 0.0);
LtoR.makeMANUAL_PID(69, 3.0, 80.0, 40.0);
LtoR.makeSTOP(70, 0.0);
LtoR.makeMANUAL_PID(71, 5.0, -65.0, 1.0);
...
goal.makeMANUAL(80, 1.0, 70.0, 0.5);
goal.makeMANUAL_PID(81, 1.0, 70.0, 20.0);
goal.makeSTOP(82, 0.0);
goal.makeMANUAL_PID(83, 5.0, -80.0, 1.0);
goal.makeSTOP(84, 0.0);
goal.makeTRACE(85, 85.0, 0.09, 0.0, 0.12, 0.3);
