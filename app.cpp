...
doubleloop.makeMANUAL_PID(20, 2.0, 60.0, -93.0);
...
doubleloop.makeMANUAL_PID(27, 2.0, 60.0, -93.0);
...
doubleloop.makeMANUAL_PID(36, 2.0, 70.0, 135.0);
doubleloop.makeMANUAL_PID(37, 5.0, 60.0, 1.0);
doubleloop.makeTRACE(38, 60.0, -0.57, 0.0, -0.32, 1.0);
doubleloop.makeSTOP(39, 0.0);
doubleloop.makeMANUAL_PID(40, 2.0, 60.0, -90.0);
doubleloop.makeSTOP(41, 0.0);
doubleloop.makeTAKE_PHOTO(42, 1.0);
doubleloop.makeSTOP(43, 0.0);
doubleloop.makeMANUAL_PID(44, 2.0, 70.0, 135.0);
doubleloop.makeMANUAL_PID(45, 5.0, 60.0, 1.0);
doubleloop.makeTRACE(46, 75.0, 0.57, 0.0, 0.32, 1.0);
doubleloop.makeSTOP(47, 0.0);
manage_scenario.add(doubleloop);

Manage_scene block("block");
block.makeSTOP(48, 0.0);
manage_scenario.add(block);

Manage_scene straight("straight");
straight.makeMANUAL_PID(49, 2.0, 60.0, -90.0);
straight.makeMANUAL_PID(50, 1.0, 50.0, 50.0);
straight.makeSTOP(51, 0.0);
manage_scenario.add(straight);

Manage_scene right("right");
right.makeMANUAL_PID(52, 2.0, 60.0, -90.0);
right.makeMANUAL_PID(53, 1.0, 50.0, 50.0);
right.makeSTOP(54, 0.0);
manage_scenario.add(right);

Manage_scene left("left");
left.makeMANUAL_PID(55, 2.0, 60.0, -90.0);
left.makeMANUAL_PID(56, 1.0, 50.0, 50.0);
