...
doubleloop.makeTRACE(12, 75.0, 0.6, 0.0, 0.4, 0.5);
doubleloop.makeMANUAL_PID(13, 2.0, 60.0, 10.0);
doubleloop.makeTRACE(14, 75.0, -0.6, 0.0, -0.4, 0.5);
doubleloop.makeSTOP(15, 0.0);
doubleloop.makeMANUAL_PID(16, 2.0, 80.0, 100.0);
doubleloop.makeSTOP(17, 0.0);
doubleloop.makeTAKE_PHOTO(18, 1.0);
doubleloop.makeSTOP(19, 0.0);
doubleloop.makeMANUAL_PID(20, 2.0, 80.0, -120.0);
doubleloop.makeMANUAL_PID(21, 5.0, -80.0, 1.0);
doubleloop.makeTRACE(22, 75.0, 0.9, 0.0, 0.7, 1.0);
doubleloop.makeSTOP(23, 0.0);
doubleloop.makeMANUAL_PID(24, 2.0, 80.0, 130.0);
doubleloop.makeSTOP(25, 0.0);
doubleloop.makeTAKE_PHOTO(26, 1.0);
doubleloop.makeSTOP(27, 0.0);
doubleloop.makeMANUAL_PID(28, 2.0, 80.0, -130.0);
doubleloop.makeMANUAL_PID(29, 5.0, -80.0, 1.0);
doubleloop.makeTRACE(30, 75.0, 0.8, 0.0, 0.7, 1.0);
doubleloop.makeTRACE(31, 75.0, 0.8, 0.0, 0.7, 0.5);
doubleloop.makeMANUAL_PID(32, 2.0, 60.0, 15.0);
doubleloop.makeTRACE(33, 60.0, -0.85, 0.0, -0.8, 0.5);
doubleloop.makeSTOP(34, 0.0);
doubleloop.makeMANUAL_PID(35, 2.0, 80.0, -100.0);
doubleloop.makeSTOP(36, 0.0);
doubleloop.makeTAKE_PHOTO(37, 1.0);
doubleloop.makeSTOP(38, 0.0);
doubleloop.makeMANUAL_PID(39, 2.0, 80.0, 130.0);
doubleloop.makeMANUAL_PID(40, 5.0, 80.0, 1.0);
doubleloop.makeTRACE(41, 70.0, -0.85, 0.0, -0.8, 1.0);
...
doubleloop.makeMANUAL_PID(47, 2.0, 80.0, 130.0);
doubleloop.makeMANUAL_PID(48, 5.0, 80.0, 1.0);
doubleloop.makeTRACE(49, 70.0, -0.85, 0.0, -0.8, 1.0);
doubleloop.makeMANUAL_PID(50, 2.0, 60.0, -45.0);
doubleloop.makeTRACE(51, 55.0, -0.12, 0.0, -0.1, 0.5);
...
whileRun.makeMANUAL_PID(61, 2.0, 60.0, -15.0);
whileRun.makeTRACE(62, 60.0, 0.6, 0.0, -0.7, 0.5);
whileRun.makeMANUAL_PID(63, 2.0, 60.0, 15.0);
whileRun.makeTRACE(64, 65.0, -1.0, 0.0, -1.0, 0.4);
...
whileRun.makeMANUAL_PID(71, 1.0, 55.0, 550.0);
