...
doubleloop.makeMANUAL_PID(44, 2, 80.0, -90.0);
...
Manage_scene nan("nan");
nan.makeMANUAL_PID(58, 1.0, 50.0, 70.0);
nan.makeTRACE(59, 50.0, 0.6, 0.0, 0.6, 0.5);
nan.makeMANUAL_PID(60, 1.0, 50.0, 70.0);
nan.makeSTOP(61, 0.0);
manage_scenario.add(nan);
