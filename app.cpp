...
run.makeTRACE(6, 85.0, 0.1, 0.0, 0.12, 0.3);
run.makeTRACE(7, 60.0, 0.1, 0.0, 0.12, 0.2);
...
doubleloop.makeTRACE(23, 75, -0.9, 0.0, -0.9, 1.0);
...
doubleloop.makeTRACE(29, 75, -0.9, 0.0, -0.9, 1.0);
doubleloop.makeCALL_SCENARIO("LtoR");
...
doubleloop.makeTRACE(51, 50, 0.67, 0.0, 0.55, 0.5);
...
straight.makeMANUAL_PID(58, 1.0, 50.0, 75.0);
straight.makeTRACE(59, 50.0, 0.6, 0.0, 0.6, 0.5);
straight.makeMANUAL_PID(60, 1.0, 50.0, 75.0);
straight.makeSTOP(61, 0.0);
manage_scenario.add(straight);

Manage_scene right("right");
right.makeMANUAL_PID(62, 2.0, 80.0, -130.0);
right.makeMANUAL_PID(63, 5.0, -80.0, 1.0);
right.makeSTOP(64, 0.0);
manage_scenario.add(right);

Manage_scene left("left");
left.makeMANUAL_PID(65, 2.0, 80.0, 80.0);
left.makeMANUAL_PID(66, 5.0, -80.0, 1.0);
left.makeSTOP(67, 0.0);
manage_scenario.add(left);

Manage_scene whileRun("whileRun");
whileRun.makeCALL_SCENARIO("RtoL");
whileRun.makeTRACE(68, 60, -0.6, 0.0, -0.7, 0.5);
whileRun.makeCALL_SCENARIO("LtoR");
whileRun.makeTRACE(69, 65, 1.0, 0.0, 1.0, 0.4);
whileRun.makeTRACE(70, 80, 0.12, 0.0, 0.1, 0.5);
...
LtoR.makeMANUAL_PID(79, 4.0, 80.0, -45.0);
LtoR.makeSTOP(80, 0.0);
LtoR.makeMANUAL_PID(81, 3.0, 80.0, 40.0);
LtoR.makeSTOP(82, 0.0);
LtoR.makeMANUAL_PID(83, 5.0, -65.0, 1.0);
LtoR.makeSTOP(84, 0.0);
manage_scenario.add(LtoR);

Manage_scene RtoL("RtoL");
RtoL.makeSTOP(85, 0.0);
RtoL.makeMANUAL_PID(86, 3.0, 80.0, 45.0);
RtoL.makeSTOP(87, 0.0);
RtoL.makeMANUAL_PID(88, 4.0, 80.0, -40.0);
RtoL.makeSTOP(89, 0.0);
RtoL.makeMANUAL_PID(90, 5.0, 65.0, 1.0);
RtoL.makeSTOP(91, 0.0);
manage_scenario.add(RtoL);

Manage_scene goal("goal");
goal.makeMANUAL(92, 1.0, 70.0, 0.5);
goal.makeMANUAL_PID(93, 1.0, 70.0, 20.0);
goal.makeSTOP(94, 0.0);
goal.makeMANUAL_PID(95, 2.0, 80.0, -80.0);
goal.makeMANUAL_PID(96, 5.0, 80.0, 1.0);
goal.makeSTOP(97, 0.0);
goal.makeTRACE(98, 55.0, -1.0, 0.0, -1.0, 0.3);
goal.makeTRACE(99, 55.0, -0.25, 0.0, -0.4, 0.3);
goal.makeSTOP(100, 0.0);
