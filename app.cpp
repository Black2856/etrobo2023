...
calibration.makeMANUAL_PID(4, 2, 70.0, 360.0);
calibration.makeCALIBRATION("stop");
calibration.makeSTOP(5, 0);
calibration.makeMANUAL_PID(6, 5, 70.0, 1.0);
calibration.makeSTOP(7, 0);
manage_scenario.add(calibration);

Manage_scene ready("ready");
ready.makeSTOP(8, 0.0);
manage_scenario.add(ready);

Manage_scene run("run");
run.makeTRACE(9, 85.0, -0.055, 0.0, -0.07, 0.5);
run.makeTRACE(10, 65.0, -0.85, 0.0, -0.42, 0.4);
run.makeTRACE(11, 85.0, -0.055, 0.0, -0.07, 0.5);
run.makeTRACE(12, 60.0, -0.85, 0.0, -0.42, 0.3);
run.makeSTOP(13, 0.0);
...
doubleloop.makeTRACE(16, 55.0, 0.4, 0.0, 0.15, 0.5);
doubleloop.makeMANUAL_PID(17, 2.0, 60.0, 15.0);
doubleloop.makeMANUAL_PID(18, 1.0, 60.0, 50.0);
doubleloop.makeMANUAL_PID(19, 2.0, 60.0, 10.0);
doubleloop.makeTRACE(20, 55.0, -0.4, 0.0, -0.15, 0.5);
doubleloop.makeMANUAL_PID(21, 2.0, 60.0, -15.0);
doubleloop.makeTRACE(22, 55.0, 0.4, 0.0, 0.15, 0.5);
doubleloop.makeMANUAL_PID(23, 2.0, 60.0, 15.0);
doubleloop.makeTRACE(24, 55.0, -0.4, 0.0, -0.15, 0.5);
doubleloop.makeTRACE(25, 60.0, -0.84, 0.0, -0.3, 0.3);
