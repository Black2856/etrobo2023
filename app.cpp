...
doubleloop.makeMANUAL_PID(52, 2, 80.0, 90.0);
doubleloop.makeMANUAL_PID(53, 5, 80.0, 1.0);
doubleloop.makeTRACE(54, 55, -1.0, 0.0, -1.0, 0.4);
...
straight.makeTRACE(57, 50.0, 0.4, 0.0, 0.6, 0.5);
straight.makeSTOP(58, 0.0);
manage_scenario.add(straight);

Manage_scene right("right");
right.makeMANUAL_PID(59, 2.0, 80.0, -80.0);
right.makeMANUAL_PID(60, 5.0, 80.0, 1.0);
right.makeSTOP(61, 0.0);
manage_scenario.add(right);

Manage_scene left("left");
left.makeMANUAL_PID(62, 2.0, 80.0, 80.0);
left.makeMANUAL_PID(63, 5.0, -80.0, 1.0);
left.makeSTOP(64, 0.0);
manage_scenario.add(left);

Manage_scene whileRun("whileRun");
whileRun.makeCALL_SCENARIO("LtoR");
whileRun.makeTRACE(65, 60, 0.6, 0.0, 0.7, 0.5);
whileRun.makeCALL_SCENARIO("RtoL");
whileRun.makeTRACE(66, 65, -1.0, 0.0, -1.0, 0.4);
whileRun.makeTRACE(67, 80, -0.12, 0.0, -0.1, 0.5);
whileRun.makeTRACE(68, 60, -0.12, 0.0, -0.1, 0.5);
whileRun.makeMANUAL_PID(69, 1, 65.0, 35.0);
whileRun.makeSTOP(70, 0);
whileRun.makeMANUAL_PID(71, 2, 80.0, -90.0);
whileRun.makeSTOP(72, 0);
whileRun.makeMANUAL_PID(73, 1, 65.0, 565.0);
whileRun.makeSTOP(74, 0);
manage_scenario.add(whileRun);

Manage_scene LtoR("LtoR");
LtoR.makeSTOP(75, 0.0);
LtoR.makeMANUAL_PID(76, 4.0, 80.0, -45.0);
LtoR.makeSTOP(77, 0.0);
LtoR.makeMANUAL_PID(78, 3.0, 80.0, 40.0);
LtoR.makeSTOP(79, 0.0);
LtoR.makeMANUAL_PID(80, 5.0, -65.0, 1.0);
LtoR.makeSTOP(81, 0.0);
manage_scenario.add(LtoR);

Manage_scene RtoL("RtoL");
RtoL.makeSTOP(82, 0.0);
RtoL.makeMANUAL_PID(83, 3.0, 80.0, 45.0);
RtoL.makeSTOP(84, 0.0);
RtoL.makeMANUAL_PID(85, 4.0, 80.0, -40.0);
RtoL.makeSTOP(86, 0.0);
RtoL.makeMANUAL_PID(87, 5.0, 65.0, 1.0);
RtoL.makeSTOP(88, 0.0);
manage_scenario.add(RtoL);

Manage_scene goal("goal");
goal.makeMANUAL(89, 1.0, 70.0, 0.5);
goal.makeMANUAL_PID(90, 1.0, 70.0, 20.0);
goal.makeSTOP(91, 0.0);
goal.makeMANUAL_PID(92, 2.0, 80.0, 80.0);
goal.makeMANUAL_PID(93, 5.0, -80.0, 1.0);
goal.makeSTOP(94, 0.0);
goal.makeTRACE(95, 55.0, 0.15, 0.0, 0.2, 0.3);
