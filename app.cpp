...
doubleloop.makeTRACE(22, 70.0, 0.6, 0.0, 0.5, 1.0);
...
doubleloop.makeTRACE(30, 70.0, 0.6, 0.0, 0.5, 1.0);
doubleloop.makeTRACE(31, 70.0, 0.6, 0.0, 0.5, 0.5);
...
doubleloop.makeTRACE(49, 75.0, -0.85, 0.0, -0.8, 1.0);
...
doubleloop.makeTRACE(55, 85.0, -0.12, 0.0, -0.1, 0.5);
