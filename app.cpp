...
doubleloop.makeMANUAL_PID(19, 2.0, 60.0, -90.0);
...
doubleloop.makeTAKE_PHOTO(23, 1.0);
doubleloop.makeMANUAL_PID(24, 2.0, 60.0, -90.0);
doubleloop.makeMANUAL_PID(25, 2.0, 60.0, -7.0);
doubleloop.makeTRACE(26, 75.0, 0.5, 0.0, 0.3, 0.5);
doubleloop.makeMANUAL_PID(27, 2.0, 60.0, 15.0);
doubleloop.makeTRACE(28, 50.0, -0.7, 0.0, -0.4, 0.5);
doubleloop.makeMANUAL_PID(29, 2.0, 60.0, 20.0);
doubleloop.makeTRACE(30, 60.0, -0.8, 0.0, -0.65, 0.5);
doubleloop.makeTRACE(31, 60.0, -0.7, 0.0, -0.4, 0.5);
doubleloop.makeMANUAL_PID(32, 1.0, 60.0, 150.0);
doubleloop.makeMANUAL_PID(33, 2.0, 55.0, -5.0);
doubleloop.makeTRACE(34, 55.0, -1.0, 0.0, -1.0, 0.5);
doubleloop.makeTRACE(35, 60.0, -1.5, 0.0, -1.0, 0.3);
doubleloop.makeTRACE(36, 85.0, -0.12, 0.0, -0.1, 0.5);
doubleloop.makeSTOP(37, 0.0);
manage_scenario.add(doubleloop);

Manage_scene block("block");
block.makeMANUAL_PID(38, 2.0, 60.0, -90.0);
block.makeMANUAL_PID(39, 1.0, 50.0, 50.0);
block.makeSTOP(40, 0.0);
