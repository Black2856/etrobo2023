...
doubleloop.makeTRACE(14, 60.0, 0.85, 0.0, 0.8, 0.5);
doubleloop.makeMANUAL_PID(15, 2.0, 60.0, 90.0);
doubleloop.makeSTOP(16, 0.0);
doubleloop.makeMANUAL_PID(17, 2.0, 60.0, -90.0);
doubleloop.makeMANUAL_PID(2.0, 60.0, -7.0);
doubleloop.makeTRACE(18, 75.0, 0.57, 0.0, 0.32, 0.5);
doubleloop.makeSTOP(19, 0.0);
doubleloop.makeMANUAL_PID(20, 2.0, 60.0, 90.0);
doubleloop.makeSTOP(21, 0.0);
doubleloop.makeMANUAL_PID(22, 2.0, 60.0, -90.0);
doubleloop.makeMANUAL_PID(23, 2.0, 60.0, -7.0);
doubleloop.makeMANUAL_PID(24, 2.0, 60.0, 15.0);
doubleloop.makeTRACE(25, 50.0, -0.7, 0.0, -0.4, 0.5);
doubleloop.makeMANUAL_PID(26, 2.0, 60.0, 20.0);
doubleloop.makeTRACE(27, 60.0, -0.8, 0.0, -0.65, 0.5);
doubleloop.makeTRACE(28, 60.0, -0.7, 0.0, -0.4, 0.5);
doubleloop.makeMANUAL_PID(29, 1.0, 60.0, 150.0);
doubleloop.makeMANUAL_PID(30, 2.0, 55.0, -5.0);
doubleloop.makeTRACE(31, 55.0, -1.0, 0.0, -1.0, 0.5);
doubleloop.makeTRACE(32, 60.0, -1.5, 0.0, -1.0, 0.3);
doubleloop.makeTRACE(33, 85.0, -0.12, 0.0, -0.1, 0.5);
doubleloop.makeSTOP(34, 0.0);
manage_scenario.add(doubleloop);

Manage_scene block("block");
block.makeMANUAL_PID(35, 2.0, 60.0, -90.0);
block.makeMANUAL_PID(36, 1.0, 50.0, 50.0);
block.makeSTOP(37, 0.0);
